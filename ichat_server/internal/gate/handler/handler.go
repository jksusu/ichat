...
import (
	...
	"ichat/internal/gate/router"
	"ichat/internal/gate/router/route"
	"ichat/pkg/ichat_cache/connect"
	websocket2 "ichat/pkg/ichat_websocket"
	"net/http"
	"net/url"
)
...
func (h *HandlerImpl) Accept(conn *websocket2.Connect, r *http.Request) (uint64, error) {
...
func (h *HandlerImpl) Receive(conn *websocket2.Connect, msg *websocket2.BusinessMessage) {
